...
public class MostAbundantStrategyTest {
    ...
    @Before
    public void initMostAbundantStrategyTest(){
        MockitoJUnit.rule();
    ...
    public void successRunningStrategy(){
        ...
        List<Stock> stocks = mostAbundantStrategy.findBestLocations(listOfStocksByLocationId);
    ...
    public void failRunningStrategy() {
        ...
        lst.add(new OrderedProduct(1, 100));

        mostAbundantStrategy.findBestLocations(lst);
    }
}
